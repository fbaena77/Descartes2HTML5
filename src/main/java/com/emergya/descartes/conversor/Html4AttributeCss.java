...
public enum Html4AttributeCss {
	...
	/** The background hr. */
	BACKGROUND_HR("color",null,"background-color: %s; border-color: %s; border-style: solid",null,null),
	...
	ALLOWTRANSPARENCY ("allowtransparency","body",null,null,"allowtransparency"),
	 ...
	 */
	private Html4AttributeCss(String attribute,String cssPath, String css, String cssUnit, String cssClass){
